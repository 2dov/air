			...
			<div class="col-md-12">
				<div class="panel panel-primary" id="departList">
					<div class="panel-heading">
						...
						<div align="right">
							<a
								href="airScheduleSearch.do?page=${currentPage>1?currentPage-1:currentPage }"
								style="text-decoration: none">이전</a>&nbsp;&nbsp;&nbsp;
							${currentPage }page / ${totalPage } pages &nbsp;&nbsp;&nbsp;<a
								href="airScheduleSearch.do?page=${currentPage<totalPage?currentPage+1:currentPage}"
							...
							<table class="table table-striped custab"
								...
								<c:forEach var="s" items="${list }">
									<tr id="selected" title="${s.s_no }" style="margin-top: 3px">
										...
										<td>${s.arrivaltime }</td>
										<td>${s.cost } 원
											<form action="checkRound.do" id="${s.s_no }" method="post">
